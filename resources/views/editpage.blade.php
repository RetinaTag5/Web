        ...
        <div class="w3-col m12">
          <div class="w3-card w3-round w3-white">
            <div class="w3-container w3-padding" style="height:300px">
			  ...
			  <form method="post" action="{{ route('post.update', $post->postid) }}">
				 {{method_field('PUT')}}
				@csrf
			  <h6 class="w3-opacity">修改文章</h6>
              <textarea  name="content" contenteditable="true" style="width:100%;height:200px"> {{$post->content }} </textarea><br/>
              <button type="submit" class="w3-button w3-theme"><i class="fa fa-pencil"></i>  Update </button> 
              </form>
			  @endforeach
			</div>
          </div>
